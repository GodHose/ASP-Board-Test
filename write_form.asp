...
If IsEmpty(Session("login")) Then
	Response.Write ("<script>alert('로그인 후에 이용하실 수 있습니다'); window.location.href='./'; </script>")
End If	
%>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="writer" name="writer" value="<%= Session("login")%>" readonly />
			</div>
			<div class="form-group">
...
<form action="./write_run.asp" method="post" name="frm">
...
$(document).ready(function(){
	...
	$(".btn-write").click(function(){
		if(confirm("글을 작성하시겠습니까?")){
			...
			document.frm.writer.value=$("#writer").val();
